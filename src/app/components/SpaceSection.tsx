...
export default function SpaceSection() {
	...
	return (
		<div className="relative z-20 h-full w-full px-4">
			...
			<div className='my-12 md:my-20 flex flex-col gap-10 md:gap-14 2xl:gap-20 align-center justify-center text-[12px]/[12px] md:text-sm font-light w-full'>
			...
			<div className='absolute bottom-35 2xl:bottom-40 left-10 md:left-20 2xl:left-40'>
				<Address />
			</div>
			<div className='absolute bottom-5 2xl:bottom-20 left-1/2 transform -translate-x-1/2 w-full flex gap-2 tracking-widest text-white font-light text-[7px] md:text-xs justify-center items-center text-center items-center overflow-hidden'>
