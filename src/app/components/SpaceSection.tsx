	...
	return (
		<div className="relative z-20 h-full w-full px-4">
			...
			<div className='my-12 md:my-15 flex flex-col gap-10 md:gap-14 2xl:gap-20 align-center justify-center text-[12px]/[12px] md:text-sm font-light w-full'>
				<h3 className="text-center text-metal-400 font-semibold text-xl bg-white w-[30vw] md:w-[15vw] 2xl:w-[10vw] mx-auto pt-1 py-0 lg:pt-0" >ESPACIO</h3>
				...
				<div className='flex flex-col items-center gap-1 2xl:gap-2 text-center font-normal text-metal-500 tracking-widest text-[10px]/[11px] md:text-[11px]/[12px] 2xl:text-[13px]/[16px]'>
					<p className='bg-white w-[70vw] md:w-[45vw] 2xl:w-[30vw] pt-1 py-0 lg:pt-0'>ENTORNO MINIMALISTA</p>
					<p className='bg-white w-[70vw] md:w-[45vw] 2xl:w-[30vw] pt-1 py-0 lg:pt-0'>REFORMER</p>
					<p className='bg-white w-[70vw] md:w-[45vw] 2xl:w-[30vw] pt-1 py-0 lg:pt-0'>TORRE | CADILLAC</p>
				</div>
			</div>
