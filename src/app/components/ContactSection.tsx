...
export default function ContactSection() {
	...
	return (
		<div className="relative z-20 h-full w-full px-4 grid grid-flow-col grid-rows-2 md:grid-rows-6">
			...
			<div className="mt-3 md:mt-0 md:row-span-3 place-self-start w-full flex flex-col md:flex-row md:justify-center items-center gap-12 md:gap-25">
				<Image
			...
			<div className="md:row-span-3 grid grid-rows-6 md:grid-rows-8 grid-cols-3 justify-items-center w-full">
				...
				<div className='row-start-6 md:row-start-7 2xl:row-start-6 col-span-3 self-center md:self-start 2xl:self-end flex justify-center items-center text-center gap-4 md:gap-12 text-white text-[8px]/[12px] 2xl:text-sm tracking-widest font-light'>
					<span>PILATES</span>
					<span>SUELO</span>
